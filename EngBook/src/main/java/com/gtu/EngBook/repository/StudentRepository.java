...
import com.gtu.EngBook.model.StudentListBaseModel;
...
public interface StudentRepository extends JpaRepository<StudentModel, Long > {
    ...
    public List<Object[]> findByCompId(@Param("comp_id") long comp_id);
    ...
    public Object findByDeptCompId(@Param("comp_id") long comp_id);

    @Query(value = "SELECT department.dept_name,user.user_id,user.fname,user.lname,user.profile_pic FROM student,college,user,department where student.comp_id= :comp_id and student.year_of_passing= :year_of_passing and student.colg_id= :colg_id and student.colg_id=college.colg_id and student.dept_id=department.dept_id and student.user_id=user.user_id", nativeQuery = true)
    public Object findByStudentCompId(@Param("comp_id") long comp_id,@Param("year_of_passing") int yop,@Param("colg_id") long colg_id);
    ...
    public Object findByStudentCompIdDept(@Param("comp_id") long comp_id,@Param("year_of_passing") int yop,@Param("colg_id") long colg_id,@Param("dept_id") long dept_id);
}
