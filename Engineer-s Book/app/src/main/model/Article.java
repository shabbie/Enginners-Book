...
public class Article implements Parcelable {
    ...
    public Article(long time, int articleid, String article_text_post, String articleImageUrl, int likes, int comments, int shares, User user, ArrayList<Comment> commentList) {
        this.time = time;
